...
// Get self profile
profilesRouter.get('/me', isAuth, controllers.getMyProfile)
...
profilesRouter.put('/:profileId/update', isAuth, controllers.updateProfile)

// Delete a profile
profilesRouter.delete('/:profileId/delete', isAuth, controllers.deleteProfile)
